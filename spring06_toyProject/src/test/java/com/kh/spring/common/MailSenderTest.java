...
public class MailSenderTest {
	...
	public void restTemplatePostTest() throws Exception{
		...
		body.add("source", "en");
		body.add("target", "ko");
		body.add("text", "Contains core classes to build the MyBatis integration with Spring3.X.");
		
		RequestEntity<MultiValueMap<String, String>> request =
				RequestEntity.post("https://openapi.naver.com/v1/papago/n2mt")
				.header("Content-type", "application/x-www-form-urlencoded; charset=UTF-8")
				.header("X-Naver-Client-Id", "NrJ3jm9CkaDUoCDrQDh9")
				.header("X-Naver-Client-Secret", "GgY8fd_fDv")
				.body(body);
